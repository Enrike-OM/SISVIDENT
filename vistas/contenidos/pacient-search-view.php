...
<div class="container-fluid">
	<ul class="full-box list-unstyled page-nav-tabs">
		...
		<li>
			<a class="active" href="<?php echo SERVERURL ?>pacient-search/"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR PACIENTE</a>
		</li>
	</ul>	
</div>
<?php
...
<div class="container-fluid">
	<form class="form-neon FormularioAjax" action="<?php echo SERVERURL; ?>ajax/buscadorAjax.php" method="POST" data-form="default" autocomplete="off">
		<input type="hidden" name="modulo" value="paciente">
		<div class="container-fluid">
			...
			<div class="row justify-content-md-center">
				<div class="col-12 col-md-6">
					<p class="text-center" style="font-size: 20px;">
						Resultados de la busqueda <strong>“<?php echo $_SESSION['busqueda_paciente']; ?>”</strong>
					</p>
				</div>
				<div class="col-12">
...
<div class="container-fluid">
	<?php
		...
		echo $ins_paciente->paginador_paciente_controlador($pagina[1],3,$_SESSION['privilegio_siscost'],$pagina[0],$_SESSION['busqueda_paciente']);
	?>
</div>
<?php } ?>