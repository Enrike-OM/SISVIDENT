<?php 
if ($lc->encryption($_SESSION['id_siscost'])!=$pagina[1]) {
...
<div class="container-fluid">
	...
	<form class="form-neon FormularioAjax" action="<?php echo SERVERURL; ?>ajax/usuarioAjax.php" method="POST" data-form="update" autocomplete="off">
				...
				<div class="row">
					<div class="col-12 col-md-4">
						<div class="form-group">
							...
							<input type="text" pattern="[0-9-]{6,20}" class="form-control" name="usuario_dni_up" id="usuario_dni" maxlength="20" value="<?php echo $campos['usuario_dni']; ?>">
						</div>
					</div>
		...
		<fieldset>
			...
			<div class="container-fluid">
				<div class="row">
					...
					<?php if($_SESSION['privilegio_siscost']==1 && $campos['usuario_id']!=1){?>
					<div class="col-12">
						<div class="form-group">
		...
		<?php if($lc->encryption($_SESSION['id_siscost'])!=$pagina[1]){ ?>
