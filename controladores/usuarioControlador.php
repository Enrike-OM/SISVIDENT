<?php
	...
	class usuarioControlador extends usuarioModelo{
		...
		public function eliminar_usuario_controlador(){
			...
			/*Comprobando id del usuario en BD*/
			...
			$check_citas=mainModel::ejecutar_consulta_simple("SELECT usuario_id FROM cita WHERE usuario_id='$id' LIMIT 1");
			if ($check_citas->rowCount()>0) {
				$alerta=[
					"Alerta"=>"simple",
					"Titulo"=>"Ocurrio un error inesperado",
					"Texto"=>"no podemos eliminar a este usuario ya que tiene cita, recomendamos deshabilitar el usuario si ya no será utilizado",
					"Tipo"=>"error"
				];
				echo json_encode($alerta);
				exit();
